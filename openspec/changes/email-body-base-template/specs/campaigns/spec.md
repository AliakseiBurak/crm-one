...
#### Scenario: Ссылка с относительным адресом сохраняется
- **WHEN** тело письма содержит ссылку с относительным адресом (например `/catalog`)
- **THEN** эта ссылка сохраняется в теле
